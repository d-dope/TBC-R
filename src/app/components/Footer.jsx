...
export default function Footer() {
  ...
  <ul className="flex mb-8 justify-center gap-20 mt-0">
                <li className="mr-4"><Link href="/" className="text-white hover:text-gray-300">Home</Link></li>
                <li className="mr-4"><Link href="/blogs" className="text-white hover:text-gray-300">Blogs</Link></li>
                <li className="mr-4"><Link href="/services" className="text-white hover:text-gray-300">Services</Link></li>
                <li><Link href="/contact" className="text-white hover:text-gray-300">Contact</Link></li>
                <li><Link href="/profile" className="text-white hover:text-gray-300">Profile</Link></li>
      </ul>
    <div className="flex justify-between items-center px-24 ">
      ...
      <div className="flex">
          <Image src={image6} alt="Logo 2" className="h-8 w-8 cursor-pointer" />
          <Image src={image7} alt="Logo 2" className="h-8 w-16 cursor-pointer" />
          <Image src={image8} alt="Logo 1" className="h-8 w-8 mr-4 cursor-pointer" />
          <Image src={image9} alt="Logo 2" className="h-8 w-8 cursor-pointer" />                           
      </div>
