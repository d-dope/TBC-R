  ...
  return (
    <article className="transform hover:scale-105 transition-transform duration-300 shadow-lg rounded-lg overflow-hidden bg-white dark:bg-primaryGray">
      ...
      <div className="p-4 bg-white dark:bg-primaryGray">
        <Link href={`/blogs/${id}`}>
          <h3 className="text-xl font-bold h-20 overflow-hidden text-gray-900 dark:text-gray-100 hover:text-blue-500 dark:hover:text-blue-400 transition-colors duration-300">
            {title}
          </h3>
        </Link>
